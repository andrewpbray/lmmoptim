...
datadir <- "/Users/michael/research/Mixed Models/data" # read the hmo data
hmo <- read.csv ( paste(datadir,"/HMO_premium_dataset_plans.csv", sep="") )
...
datadir <- "/Users/michael/research/Mixed Models/data" # read the hmo data
hmo <- read.csv ( paste(datadir,"/HMO_premium_dataset_plans.csv", sep="") )
statevars <- read.csv ( paste(datadir,"/HMO_premium_dataset_states.csv", sep="") )
hmobig <- left_join ( hmo, statevars, by="state")
y <- hmobig$indPrem
n <- length(y)
