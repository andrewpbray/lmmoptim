...
boxes.HH11 <- fitlmm ( lines=lines, mlrebox, eps=5, delE=log(10), delS=log(10),
                       ratio=TRUE, M=5, maxit=10, lognote = "First ME model v1")
####################
...
####################
boxes.HH11 <- fitlmm ( lines=lines, box2, eps=1, M=10, maxit=7, lognote = "Refined ME model v1")
####################
